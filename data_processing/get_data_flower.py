...
#
train_dir = os.path.join('/home/shaokun/Downloads/flowerimage', 'train')
train = datasets.ImageFolder(train_dir, transform=preprocess)
print(train.classes)
test_dir = os.path.join('/home/shaokun/Downloads/flowerimage', 'test')
...
fname = '{}_flower_{}.npy'.format(args.task, args.shot)
